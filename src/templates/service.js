...
const SERVICE_DESIGN_SYSTEM_PILOT_SLUGS = new Set(['cctv-installation', 'alarm-systems', 'access-control', 'gate-automation', 'fire-detection', 'home-networking', 'smart-home-automation']);
...
const SERVICE_HERO_PHOTO = {
  ...
  'alarm-systems': {
    ...
    alt: 'Terracotta-walled Algarve villa protected by an alarm system, with a camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  'access-control': {
    ...
    alt: 'Terracotta-walled Algarve villa entrance fitted with access control, a camera mounted above the roofline, olive trees and glass sliding doors marking the access point',
  },
  'gate-automation': {
    ...
    alt: 'Terracotta-walled Algarve villa with automated entrance security, a camera mounted above the roofline, olive trees and glass sliding doors at the property entrance',
  },
  'fire-detection': {
    mobileWebp: '/assets/images/hero-security-fire-detection-mobile.webp',
    ...
    alt: 'Terracotta-walled Algarve villa covered by fire detection alongside exterior security, with a camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  'home-networking': {
    ...
    alt: 'Terracotta-walled Algarve villa with a networked security camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  'smart-home-automation': {
    mobileWebp: '/assets/images/hero-security-smart-home-automation-mobile.webp',
    mobileJpg: '/assets/images/hero-security-smart-home-automation-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-smart-home-automation-desktop.webp',
    desktopJpg: '/assets/images/hero-security-smart-home-automation-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa fitted with smart home automation, including a camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
};
