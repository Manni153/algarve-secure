...
const TOWN_HERO_PHOTO = {
  ...
  alvor: {
    mobileWebp: '/assets/images/hero-security-alvor-mobile.webp',
    mobileJpg: '/assets/images/hero-security-alvor-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-alvor-desktop.webp',
  ...
  lagoa: {
    mobileWebp: '/assets/images/hero-security-lagoa-mobile.webp',
    mobileJpg: '/assets/images/hero-security-lagoa-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-lagoa-desktop.webp',
    desktopJpg: '/assets/images/hero-security-lagoa-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa near Lagoa with a discreet CCTV camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  carvoeiro: {
    mobileWebp: '/assets/images/hero-security-carvoeiro-mobile.webp',
    mobileJpg: '/assets/images/hero-security-carvoeiro-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-carvoeiro-desktop.webp',
  ...
  vilamoura: {
    mobileWebp: '/assets/images/hero-security-vilamoura-mobile.webp',
    mobileJpg: '/assets/images/hero-security-vilamoura-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-vilamoura-desktop.webp',
    desktopJpg: '/assets/images/hero-security-vilamoura-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa near Vilamoura with a discreet CCTV camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  quarteira: {
    mobileWebp: '/assets/images/hero-security-quarteira-mobile.webp',
    mobileJpg: '/assets/images/hero-security-quarteira-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-quarteira-desktop.webp',
  ...
  almancil: {
    mobileWebp: '/assets/images/hero-security-almancil-mobile.webp',
    mobileJpg: '/assets/images/hero-security-almancil-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-almancil-desktop.webp',
    desktopJpg: '/assets/images/hero-security-almancil-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa near Almancil with a discreet CCTV camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  faro: {
    mobileWebp: '/assets/images/hero-security-faro-mobile.webp',
    mobileJpg: '/assets/images/hero-security-faro-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-faro-desktop.webp',
  ...
  'castro-marim': {
    mobileWebp: '/assets/images/hero-security-castro-marim-mobile.webp',
    mobileJpg: '/assets/images/hero-security-castro-marim-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-castro-marim-desktop.webp',
    desktopJpg: '/assets/images/hero-security-castro-marim-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa near Castro Marim with a discreet CCTV camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
  'vila-real-de-santo-antonio': {
    mobileWebp: '/assets/images/hero-security-vila-real-de-santo-antonio-mobile.webp',
    mobileJpg: '/assets/images/hero-security-vila-real-de-santo-antonio-mobile.jpg',
    desktopWebp: '/assets/images/hero-security-vila-real-de-santo-antonio-desktop.webp',
    desktopJpg: '/assets/images/hero-security-vila-real-de-santo-antonio-desktop.jpg',
    alt: 'Terracotta-walled Algarve villa near Vila Real de Santo António with a discreet CCTV camera mounted above the roofline, olive trees and glass sliding doors at the entrance',
  },
};
...
const TOWN_DESCRIPTION_PHOTO = {
  ...
  lagoa: {
    ...
    alt: 'Villa terrace near Lagoa overlooking cliffside coves and the Atlantic',
  },
  carvoeiro: {
  ...
  vilamoura: {
    ...
    alt: 'Villa terrace near Vilamoura overlooking the marina and golf estates',
  },
  quarteira: {
  ...
  almancil: {
    ...
    alt: 'Villa terrace near Almancil overlooking golf courses and manicured grounds',
  },
  faro: {
  ...
  'castro-marim': {
    ...
    alt: 'Villa terrace near Castro Marim overlooking the salt marshes and hilltop castle',
  },
  'vila-real-de-santo-antonio': {
    ...
    alt: 'Villa terrace near Vila Real de Santo António overlooking the Guadiana river and the Spanish border',
  },
};
